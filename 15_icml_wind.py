    ...
    for b in BLOCKS:
        ...
        for r in xrange(REPS):
            ...
            if not all_auc.has_key('SSVM'):
                ...
                all_auc['OcSvm Spectrum (4)'] = []
                all_auc['OcSvm Spectrum (8)'] = []
                all_auc['SSVM'] = []
                all_auc['HMAD'] = []
                # collect fscores,..
                all_res['SSVM'] = []
